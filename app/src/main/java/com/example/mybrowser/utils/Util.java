package com.example.mybrowser.utils;
...
public class Util {
    ...
    public static void setUA(Boolean ifUAchanged){mEditor.putBoolean("PC",ifUAchanged).commit();}

    public static Boolean getUA(){return mSP.getBoolean("PC",true); }
