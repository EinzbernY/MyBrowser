...
import com.example.mybrowser.setting.SettingFragment;
...
//    private static final String QUERY = "https://www.sogou.com/web?query=";//搜狗
//    private static final String QUERY = "https://cn.bing.com/search?q=";//必应
    private static final String QUERY = "http://www.baidu.com/s?wd=";//百度
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mSearchRes = view.findViewById(R.id.web_view);
        mFullVideo = view.findViewById(R.id.full_video);
        mNavigationBar = view.findViewById(R.id.navigation_bar);
        ...
        mSearchRes.setDownloadListener((url, userAgent, contentDisposition, mimetype, contentLength) -> {
        ...
        change_vol_bright = view.findViewById(R.id.gesture_layout);
        mGestureImage = view.findViewById(R.id.volume_bright_image);
        mGestureTextView= view.findViewById(R.id.percentage_volume_bright);


        myTouchListener = event -> {
            Log.d(TAG,"myTouchListener: "+ event.getAction());
        ...
        mSearchRes.setOnKeyListener((v, keyCode, event) -> {
        ...
        mSearchRes.setWebViewClient(new MyWebViewClient(){
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (BlockerTool.isBlock(MyApplication.getContext(), url)) {
                    mLoad = url;
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                //如果打开了UA开关，修改浏览器UA
                if(Util.getInstance().getUA()){
                    mSearchRes.getSettings().setUserAgentString("PC");
                    mSearchRes.getSettings().setSupportMultipleWindows(false);
                    mSearchRes.getSettings().setJavaScriptEnabled(true);
                    mSearchRes.getSettings().setDomStorageEnabled(true);
                    mSearchRes.getSettings().setDatabaseEnabled(true);
                    mSearchRes.getSettings().setUseWideViewPort(true);
                    mSearchRes.getSettings().setLoadWithOverviewMode(true);
                    mSearchRes.getSettings().setBuiltInZoomControls(true);
                    mSearchRes.getSettings().setSupportZoom(true);
                    mSearchRes.requestFocusFromTouch();
                }else mSearchRes.getSettings().setUserAgentString("Linux/Android");
                //如果打开了夜间模式，修改webview
    ...
    private void showDialog(String url) {
        ...
        builder.setPositiveButton(R.string.OK, (dialogInterface, i) -> mSearchRes.loadUrl(url));
